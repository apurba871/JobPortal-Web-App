...
import com.dev.jobportal.entity.RecruiterJobsDto;
    ...
    public String searchJobs(Model model) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                List<RecruiterJobsDto> recruiterJobs = jobPostActivityService.getRecruterJobs(((RecruiterProfile)currentUserProfile).getUserAccountId());
